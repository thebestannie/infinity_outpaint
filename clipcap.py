...
output_dir = './caption/'  # Set the path to the directory to store the output files
...
for img_path in img_paths:
    ...
    txt_path = os.path.join(output_dir, img_name + '.txt')  # Set the path to the output text file
    text = inference(img_path, 'xx')  # Call the inference function for each image
    with open(txt_path, 'w') as f:
        f.write(text)  # Write the text to the output file
